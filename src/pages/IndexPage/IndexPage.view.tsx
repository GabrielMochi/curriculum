...
import { IndexControllerReturn } from "./IndexPage.interface";
...
const IndexPageView = ({ t }: IndexControllerReturn): ReactElement => (
  // TODO: Conclusion: we dont need a template for this project
  <DefaultTemplate
    test={<Header subTitle="" title="" />}
    header={{
      title: (
        <>
